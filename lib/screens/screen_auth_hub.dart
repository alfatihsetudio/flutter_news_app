...
import 'dart:ui' show ImageFilter; // untuk BackdropFilter.blur
...
class _ScreenAuthHubState extends State<ScreenAuthHub> {
  ...
  // Styles (tanpa withOpacity → pakai ARGB supaya aman dari deprecation)
  static const Color kGlassFill = Color(0x1AFFFFFF);   // ~10% white
  ...
  Future<void> _fetchProfile() async {
    ...
    try {
      final me = await AuthService.instance.profile(t);
  ...
  Future<void> _onLogin() async {
    ...
    try {
      final token =
          await AuthService.instance.login(email: email, password: pass);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                const Icon(Icons.verified_user_outlined, color: kTextPrimary),
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    (_token == null || _token!.isEmpty) ? 'Status: Tamu' : 'Status: Masuk',
                                ...
                                if (_token != null && _token!.isNotEmpty)
                                  TextButton.icon(
                                    ...
                                    label: const Text('Logout', style: TextStyle(color: kTextPrimary)),
                                  ),
                              ],
                            ),
                          ),
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(entries[i].$2, size: 18, color: selected ? Colors.white : kTextMuted),
      ...
      children: [
        ...
        Center(
          child: TextButton(
            ...
            child: const Text('Belum punya akun? Daftar', style: TextStyle(color: kTextPrimary)),
          ),
        ),
      ],
    );
      ...
      children: [
        ...
        Center(
          child: TextButton(
            ...
            child: const Text('Sudah punya akun? Masuk', style: TextStyle(color: kTextPrimary)),
          ),
        ),
      ],
    );
  ...
  Widget _profileView() {
    final me = _me;
    final loggedIn = (_token != null && _token!.isNotEmpty && me != null);
    ...
    return Column(
      ...
      children: [
        if (!loggedIn) ...[
          ...
          const Text('Belum login.', style: TextStyle(color: kTextPrimary, fontSize: 16)),
          const SizedBox(height: 4),
          const Text('Silakan masuk terlebih dahulu di tab Login.', style: TextStyle(color: kTextMuted)),
  ...
  Widget _textField({
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: Color(0x1FFFFFFF), // ~12% white
